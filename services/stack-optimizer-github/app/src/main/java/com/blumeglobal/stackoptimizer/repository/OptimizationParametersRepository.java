 ...
 * questions.
 */
package com.blumeglobal.stackoptimizer.repository;
...
@Repository
public interface OptimizationParametersRepository extends JpaRepository<OptimizationParameters, Long>
{
    public List<OptimizationParameters> findAllByLocationUUID(String locationUUID);
}
