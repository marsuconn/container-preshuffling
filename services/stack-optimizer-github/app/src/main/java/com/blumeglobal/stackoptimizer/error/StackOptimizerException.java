...
public class StackOptimizerException extends RuntimeException
{
    protected final StackOptimizerErrorCode errorCode;
    protected final Throwable exception;
    protected final String customErrorMessage;

    public StackOptimizerException(@NonNull StackOptimizerErrorCode errorCode, @Nullable Throwable exception,
            @Nullable String customErrorMessage)
    {
        super(exception);
